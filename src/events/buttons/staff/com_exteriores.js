...
export default {
    ...
    /**
     * Ejecuta la lógica del botón para asignar/remover el rol de Exteriores
     * @param {Interaction} interaction - La interacción del botón
     * @param {Client} client - El cliente de Discord
     */
    async execute(interaction, client) {
        // ID del rol de la comisión de Exteriores
        const roleId = '1292466970687442984';
        const roleName = 'Exteriores';
        ...
        try {
            ...
            if (!role) {
                return await interaction.reply({
                    content: '<:no:1288631410558767156> No se pudo encontrar el rol de Exteriores.',
