...
export default {
    ...
    /**
     * Ejecuta la lógica del botón para asignar/remover el rol de Comunicación
     * @param {Interaction} interaction - La interacción del botón
     * @param {Client} client - El cliente de Discord
     */
    async execute(interaction, client) {
        // ID del rol de la comisión de Comunicación
        const roleId = '1292466863707521167';
        const roleName = 'Comunicación';
        ...
        try {
            ...
            if (!role) {
                return await interaction.reply({
                    content: '<:no:1288631410558767156> No se pudo encontrar el rol de Comunicación.',
